...
C-ROADS-ilmastomallilla on ennustettu, että ilmaston lämpenemisen rajoittamiseksi 2 \degree C:een olisi globaalisti hiilidioksidipäästöjä leikattava vuoteen 2050 mennessä 80 \% vuoden 1990 tasosta ja metsien tuhoutumisesta syntyviä päästöjä 90 \%  vuoden 2009 tasosta. \cite{Sawin2009} Leikattavaa olisi siis paljon enemmän, kuin millaisiin leikkaustavoitteisiin Kööpenhaminen ilmastokokouksessa päästiin vuonna 2009. \cite{UNFCCCCopenhagen}
...
\subsection{Muita systeemidynaamisia ilmastomalleja \label{ilmasto:muut}}

En-ROADS (Energy Rapid Overview and Decision Support) on FREE-ilmastomalliin pohjautuva, C-ROADS-ilmastomallista laajennettu, yhdistetty ilmastomalli. Siinä missä C-ROADS-malli keskittyi pääasiassa tutkimaan kasvihuonekaasupäästöjen leikkausten vaikutuksia ilmastoo, tutkii En-ROADS, miten muun muassa teknologisen kehityksen, bruttokansantuotteen kasvun ja päästökaupan vaikutukset päästöihin ja siten ilmastoon. \cite{EnroadsWWW, Harvey2013}

C-ROADS:n tavoin En-ROADS-simulaation ajaa sekunnin murto-osassa. \cite{EnroadsWWW}

En-ROADS:ssa ei C-ROADS:sta poiketen voi maailmaa pilkkoa eri alueisiin. \cite{EnroadsWWW}
