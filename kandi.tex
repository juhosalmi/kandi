...
Tämän luvun tavoite on tutustuttaa lukija ilmastonmuutoksen mallintamiseen ensin yleisesti ja sitten systeemidynaamisiin malleihin pureutuen. Aluksi aliluvussa \ref{ilmasto:historia} otetaan katsaus ilmastotieteen, -mallien ja -politiikan historiaan. Historiaosuuden tavoite on auttaa ymmärtämään taustaa, miksi mallintamiseen on alettu käyttää myös systeemidynaamisia menetelmiä. Tässä työssä esitellään kolme systeemidynaamista ilmastomallia, joista fysikaaliseen C-ROADS-ilmastomalliin paneudutaan aliluvussa \ref{ilmasto:croads} kunnolla, minkä jälkee aliluvuissa \ref{ilmasto:enroads} ja \ref{ilmasto:free} otetaan nopea katsaus yhdistettyihin En-ROADS- ja FREE-ilmastomalleihin. Lopuksi aliluvussa \ref{ilmasto:seuraukset} tutustutaan vielä ilmastonmuutoksen seurausten tutkimiseen systeemidynamiikan avulla.  
...
C-ROADS (Climate-Rapid Overview And Decision Support) on yksinkertainen fysikaalinen ilmastomalli, joka perustuu Fiddamanin \cite{Fiddaman1997} kehittämään systeemidynaamiseen FREE-ilmastomalliin. C-ROADS on viritetty ja osoitettu toimivaksi historiadatan ja sekä tarkkojen fysikaalisten mallien avulla. Malli kykenee siis toistamaan historiadatan käyttäytymistä sekä antaa eri kasvuodotusparametrein samoja ennusteita kuin parhaat tarkimmista ilmastomalleista. \cite{CroadsWWW, CroadsFlightSimulator2011} 
...
Climate Interactiven Andrew Jones \cite{Jones2013} kertoo, että he pitävät tyypillisesti kahden tunnin tilaisuuksia, joiden aikana yleisö oppii ymmärtämään C-ROADS:n avulla ilmaston dynamiikkaa ja ilmastopäätösten seurauksia. Yleisö oppii myös simuloimaan erilaisia skenaarioita C-ROADS:n avulla. 
...
\begin{figure}[H]
\centering \includegraphics[width=\textwidth]{c-roads-lampo}
...
C-ROADS-ilmastomallilla on ennustettu, että ilmastonlämpenemisen rajoittamiseksi 2 \degree C:een olisi hiilidioksidipäästöjä leikattava globaalisti 80 \% ja metsien tuhoutumisesta syntyviä päästöjä 90 \%  vuoden 1990 tasosta. \cite{CroadsFlightSimulator2011} % Ennuste johonkin hyvään paikkaan ja viite siihen tulospaperiin

C-ROADS:n arviointiryhmä antoi vuonna 2009 lausunnon, että malli ajaa asiansa: sen käyttäyttäytyminen noudattaa parhaiden ilmastomallien käyttäytymistä ja se toimii tehokkaana työkaluna kohdeyleisölle. Arviointiryhmä huomautti, että mallin pitäisi selkeämmin viestiä sen todellisia kykyjä mallintaa ilmastoa sekä kertoa epävarmuustekijöistä, jotka malliin liittyvät. Arviointiryhmä ehdotti myös, että malliin lisättäisiin osa pois jätetyistä takaisinkytkennöistä. \cite{Watson2009} C-ROADS-ilmastomallia on kehitetty tämän jälkeen. \cite{Fiddaman2012, Croads} % Arviointiryhmän lausunto jonnekin fiksuun paikkaan 

\subsection{En-ROADS-ilmastomalli \label{ilmasto:enroads}}

\subsection{FREE-ilmastomalli \label{ilmasto:free}}

\subsection{Ilmastonmuutoksen seurausten arviointi systeemidynamiikalla \label{ilmasto:seuraukset}}
