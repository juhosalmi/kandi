...
Systeemidynamiikka vaikuttaa erittäin tehokkaalta tavalta toteuttaa yksinkertaisia ilmastomalleja. Mallinnuksessa on edullista, että systeemidynamiikassa keskitytään tutkimaan takaisinkytkentöjä, epälineaarisuuksia, viiveitä, varastoja ja virtauksia. Tämä vaikuttaisi ilmeisen tehokkaalta lähestymistavalta, sillä systeemidynaamisten mallien ennusteet noudattavat historiadataa sekä parhaiden tarkkojen ilmastomallien ennusteita. Systeemidynaamisiin malleihin on mallinnettu spekulatiivisia osia, kuten takaisinkytkentöjä, joiden käyttäytymistä ei täysin tunneta. Niiden herkkyysparametreja säätämällä voi spekuloida systeemin todellista käyttäytymistä. Lisäksi systeemidynaamisen ilmastosimulaation ajaa sekunnin murto-osassa. Nämä ovat kuitenkin vain perusedellytykset hyvälle yksinkertaiselle ilmastomallille. 
