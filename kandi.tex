...
Tarkkojen ilmastomallien lisäksi kehitettiin yksinkertaisia ilmastomalleja, joilla saatettiin esimerkiksi pureutua yksittäisiin ilmastokysymyksiin. Yksinkertaisissa malleissa maapallo voidaan esimerkiksi mallintaa yhtenä kokonaisuutena sen sijaan, että mallinnettaisiin ilmakehä lukuisiin palasiin jaettuna kolmiulotteisena hilana. \cite{AmericanInstituteofPhysicsSimple} Seuraavissa aliluvuissa esiteltävät systeemidynaamiset mallit ovat yksinkertaisia ilmastomalleja, joista ensimmäisen julkaisi Tom Fiddaman väitöskirjassaan vuonna 1997 \cite{Fiddaman1997}. 
...
C-ROADS (Climate-Rapid Overview And Decision Support) on fysikaalinen ilmastomalli ja perustuu Fiddamanin \cite{Fiddaman1997} kehittämään systeemidynaamiseen FREE-ilmastomalliin. C-ROADS:n tarkoitus on auttaa ihmisiä ymmärtämään ilmastopoliittisten päätösten pitkäaikaiset seuraukset. \cite{CroadsWWW, CroadsFlightSimulator2011}
