...
Systeemidynamiikka on tietokoneavusteinen lähestymistapa päätöksentekoon ja monimutkaisten järjestelmien mallintamiseen. Keskeistä systeemidynamiikassa on järjestelmän osien keskinäinen vuorovaikutus. \cite{WhatIsSystemDynamics}

Tämän luvun tavoite on tutustuttaa lukija systeemidynamiikkaan. 

\subsection{Systeemidynamiikan historia}
...
Tämäkään ei ole vielä kokototuus, vaan päätösten seurauksena muuttuva ympäristö vaikuttaa omiin tavoitteisiin ja esim. kilpailijoiden tavoitteisiin ja toimintaan sekä aiheuttaa muita sivuvaikutuksia (Kuva \ref{laajennettutakaisinkytkentasuuntautunut}). 
