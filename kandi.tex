...
Systeemi eli järjestelmä tarkoittaa toistensa kanssa vuorovaikutuksessa olevien osien muodostamaa kokonaisuutta \cite{Flood1988}. Systeemidynamiikka on tietokoneavusteinen lähestymistapa päätöksentekoon ja mutkikkaiden systeemien mallintamiseen \cite{WhatIsSystemDynamics}. Mutkikkaalle systeemille ei ole yksikäsitteistä määritelmää, mutta systeemin mutkikkuutta lisäävät sen epälineaarisuudet ja takaisinkytkennät \cite{Zadeh1973}. Nämä ovat systeemidynaamisessa mallintamisessa keskeisiä ominaisuuksia \cite{WhatIsSystemDynamics}. % systeemin ja mutkikkaan systeemin määrittelyt viitteet kuntoon! 

mutta systeemidynamiikassa tutkitaan erityisesti systeemin takaisinkytkentöjä ja epälineaarisuuksia, jotka ovat systeemin mutkikkuutta lisääviä ominaisuuksia. 
